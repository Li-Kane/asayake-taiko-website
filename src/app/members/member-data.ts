...
export const k_miyasaki: Member = {
    ...
    gen: 22,
    favSong: "No Answer",
    introduction: "Katelyn is a grad student studying bioengineering. She often saw taiko performances growing up and is excited to be performing herself! She wanted to put her favorite Asa song in this bio, but couldn’t pick just one. Besides taiko, Katelyn likes sports anime, making playlists, and typography.",
    state: "default"
}
...
export const m_alegrado: Member = {
    ...
    gen: 22,
    favSong: "No Answer",
    introduction: "Hello, I'm Matthew and I'm a 2nd year Electrical Engineering major. I was born in Chula Vista, CA. This is my first year in Asa and my first year playing taiko.I joined Asa because I liked doing percussion in high school and I found out about Asa after a friend of mine joined a similar group. I liked the environment during tryouts with the way everyone helps each other and had fun together.",
    state: "default"
}
...
export const t_hsiao: Member = {
    ...
    gen: 22,
    favSong: "No Answer",
    introduction: "HI! I am Timothy Hsiao, and I am a first year Bioinformatics major at UC San Diego. This is my first year playing taiko, and I am having a great time so far! In addition to taiko, I also play piano, cello, and guitar, and I am learning violin and fue!",
    state: "default"
}
...
export const a_adriano: Member = {
    ...
    gen: 21,
    favSong: "No Answer",
    introduction: "Aleck is a 3rd year studying music tech at UCSD. He enjoys the physical, musical, visual, and social aspects of taiko playing. Outside of taiko, he performs with his cover band in SD, and is commonly seen working audio tech for events around UCSD. In his free time he enjoys making music and making gains. He also enjoys playing games like Team Fight Tactics!",
    state: "default"
}
...
export const d_tayag: Member = {
    ...
    gen: 21,
    favSong: "No Answer",
    introduction: "Darryl is a 4th year. He loves rocks, cows, and his dog Yogi. His go-to Vallarta's order is Super Fries with Carnitas and a large horchata. If you're reading this message right now, you should get him some.",
    state: "default"
}
...
export const k_kaneshiro: Member = {
    ...
    gen: 21,
    favSong: "No Answer",
    introduction: "Kade is a current 2nd year studying Structural Engineering. Their musical background includes wind ensemble, jazz ensemble, marching band, and a garage band. Wanting to continue the music coming into UC San Diego, they discovered Asayake through a student org pamphlet, tried out, and stayed ever since! Kade is the Public Relations Chair and the Social Chair for Asayake Taiko, managing the organization’s social media presence and planning social events within the club. Outside of taiko, he enjoys exploring music genres, thrifting, making and drinking coffee, looking at furniture (huge IKEA fan), DND, and hanging out with the homies.",
    state: "default"
}
...
export const t_koh: Member = {
    ...
    gen: 21,
    favSong: "Kamaitachi",
    introduction: "Salutations! My name is Truman Koh and I am a 3rd year general biology major studying at UC San Diego. I joined Asayake because of my love for music and Japanese culture. I have been playing taiko for 2 years. My previous ventures include Taekwondo, saxophone, and singing. Outside of taiko I spend the majority of my time working in a labratory doing science stuff and gaming with friends. Currently my favorite song in Asa's repertoire is Kamaitachi because of the combinations between the energetic movements and intense rhythms. My favorite part of Asa are the people.",
    state: "default"
}
...
export const w_chu: Member = {
    ...
    gen: 20,
    favSong: "Taifuu",
    introduction: "William is a third year majoring in bioinformatics. He played Chinese percussion for 10 years before trying out for Asayake Taiko, and now he is grateful to be learning and performing taiko! His favorite piece to perform is Taifuu, because it's a very intense and fun song to play.",
    state: "default"
}
...
export const n_saito: Member = {
    ...
    gen: 19,
    favSong: "Tanoshii",
    introduction: "Hello, my name is Nikki Saito! I’m from Honolulu, Hawaii and a fourth year in Warren college majoring in Neurobiology and double minoring in Chinese Studies and Business. I am the current Administrative Director for Asa! I have played taiko for 10 years and I joined Asa because of the great people and the fun songs we play! My favorite song is Tanoshii! Outside of taiko, I am the Vice President of External Affairs for Associated Students where I am UCSD's representative to the UC Student Association and UC Board of Regents!",
    state: "default"
}
