...
export const k_miyasaki: Member = {
    ...
    gen: "22",
    favSong: "No Answer",
    quote: "Katelyn is a grad student studying bioengineering. She often saw taiko performances growing up and is excited to be performing herself! She wanted to put her favSongorite Asa song in this bio, but couldn’t pick just one. Besides taiko, Katelyn likes sports anime, making playlists, and typography.",
    state: "default"
}
export const k_villadelgado: Member = {
    ...
    gen: "22",
    favSong: "No Answer",
    quote: "YO! My name is Kateleen (Kate) Villadelgado. I’m a freshman at UCSD and my major is Japanese Studies. I've always loved the energy of taiko but this is my first time actually playing taiko! It's been really fun learning new songs and especially hanging out with the Asa Fam. Even though it's my first year here in Asayake Taiko, I already feel like I belong. Other than taiko, I really enjoy drawing fictional characters, trying (and failing) to 100% complete all Yakuza games, and singing badly. Also, my favSongorite food is curry (Coco Ichibanya go crazy). All in all, I’m here to live a good life, not a long one. We gamin’ frfr",
    state: "default"
}
...
export const k_dickens: Member = {
    ...
    gen: "21",
    favSong: "No Answer",
    quote: "Hi! My name is Keiko and I’m a second year majoring in International Business and Sociology. I was interested in taiko through my previous experiences doing eisa drumming and being in music ensembles! My favSongorite song in Asa is Kamaitachi because of the two different chu parts that come together in a really cool way! In my spare time, I enjoy going on unplanned adventures to get boba, crocheting, and watching TV shows & movies (some of my favSongorites are The Batman, The Lego Batman Movie, The Last of Us, and The Mandalorian teehee). My dream is to appear in TV shows and movies as an extra and be in stock photos :)",
    state: "default"
}
...
export const t_koh: Member = {
    ...
    gen: "21",
    favSong: "Kamaitachi",
    quote: "Salutations! My name is Truman Koh and I am a 3rd year general biology major studying at UC San Diego. I joined Asayake because of my love for music and Japanese culture. I have been playing taiko for 2 years. My previous ventures include Taekwondo, saxophone, and singing. Outside of taiko I spend the majority of my time working in a labratory doing science stuff and gaming with friends. Currently my favSongorite song in Asa's repertoire is Kamaitachi because of the combinations between the energetic movements and intense rhythms. My favSongorite part of Asa are the people.",
    state: "default"
}
...
export const w_chu: Member = {
    ...
    gen: "20",
    favSong: "Taifuu",
    quote: "William is a third year majoring in bioinformatics. He played Chinese percussion for 10 years before trying out for Asayake Taiko, and now he is grateful to be learning and performing taiko! His favSongorite piece to perform is Taifuu, because it's a very intense and fun song to play.",
    state: "default"
}
